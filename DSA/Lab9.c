...
Output :
Polynomial P(x,y,z): +6*x^2*y^2*z^1 -4*x^0*y^1*z^5 +3*x^3*y^1*z^1 +2*x^1*y^5*z^1 -2*x^1*y^1*z^3
Evaluation at (x=1,y=2,z=1): 82
POLY1: +3*x^2*y^1*z^0 +4*x^0*y^0*z^2
POLY2: +5*x^2*y^1*z^0 -4*x^0*y^0*z^2
POLYSUM = POLY1 + POLY2: +8*x^2*y^1*z^0 +0*x^0*y^0*z^
